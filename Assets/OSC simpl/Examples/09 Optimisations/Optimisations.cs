...
namespace OscSimpl.Examples
{
	public class Optimisations : MonoBehaviour
	{
		...
		OscBundle bundle;
		UnityAction<float> OnCachedReceived_Event;
		...
		void Start()
		{
			...
			oscOut.Open( 7000 );
			oscIn.Open( 7000 );
			OnCachedReceived_Event = OnCachedReceived;
			oscIn.Map( floatAddress, OnCachedReceived_Event);
		...
		void Update()
		{
			...
			floatMessage.args[0] = UnityEngine.Random.value;
